...
Fig_2e <- ggplot(dm, aes(x=pGC, y=fc_rp)) + 
...
fitII_noser <- lmodel2(fc_rodent ~ fc_primate, data=no_serine, range.y="interval", range.x="interval", nperm=99)
reg_noser <- fitII_noser$regression.results
...
cor.test(no_serine$fc_primate, no_serine$Pnoratio, method='pearson') #R=0.60 p=0.007
cor.test(no_serine$fc_rodent, no_serine$Rnoratio, method='pearson') #R=0.38 p=0.1
```

### Figure 4
```{r Figure 4}
cor.test(dm$projections_m2,dm$text_jordan, method='pearson')
cor.test(dm$projections_m2,dm$supp_jordan, method='pearson')
...
cor.test(dm$projections_m2,dm$TrifonovConsensusOrderOfRecruitment, method='pearson')
cor.test(dm$projections_m2,dm$yps, method='pearson')

cor.test(dm$Disorder_Propensity,dm$projections_m2, method='spearman') #R=-0.643609, p=0.002778
cor.test(dm$Disorder_Propensity,dm$projections_m2, method='pearson') #R=-0.7125097, p=0.0004233
weightedCorr(dm$Disorder_Propensity,dm$projections_m2, method='spearman', weights=dm$projection_error) #R=-0.6662545

cor.test(dm$Levy_Stickiness,dm$projections_m2, method='spearman') #R=0.62 p=0.004
...
### Figure 5
```{r Figure 5}
cor.test(dm$residuals_m2,dm$kldCAISslope_Proteome, method='pearson') #R=0.709, p=0.0005
weightedCorr(dm$residuals_m2,dm$kldCAISslope_Pfam, method='spearman', weights=dm$residual_error) #R=0.597

cor.test(dm$residuals_m2,dm$kldCAISslope_Pfam, method='pearson') #R=0.677, p=0.001
weightedCorr(dm$residuals_m2,dm$kldCAISslope_Pfam, method='spearman', weights=dm$residual_error) #R=0.597

cor.test(dm$Levy_Stickiness,dm$residuals_m2, method='spearman') #signif
cor.test(dm$Mean_RSA,dm$residuals_m2, method='spearman')  #signif
cor.test(dm$Polarity,dm$residuals_m2, method='spearman')  #signif
...
cor.test(dm$PAM_sub,dm$residuals_m2, method='spearman')  #signif
...
cor.test(dm$N3redun,dm$residuals_m2, method='spearman') #R=0.532, p=0.0158  #signif
cor.test(dm$num_Codons,dm$residuals_m2, method='spearman') #R=0.484, p=0.0308

cor.test(dm$N3redun,dm$kldCAISslope_Proteome, method='spearman') #R=0.681, p=0.001
cor.test(dm$num_Codons,dm$kldCAISslope_Proteome, method='spearman') #R=0.671, p=0.001
...
var(n2_cais_proteome2$kldC AISslope_Proteome) #0.01081791
