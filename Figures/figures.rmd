...
Fig3a<-ggplot(dm, aes(x=projections_m2, y=Jordan_st1_D)) +
  ...
  annotate(geom="text", x=xpos_hi(dm$projections_m2), y=-0.28, label=paste("R = ", signif(pjs_st1$estimate, digits=3), "\n p = ", signif(pjs_st1$p.value, digits=1)), color="black", size=6) + 
...
Fig4<-ggplot(dm, aes(x=residuals_m2, y=CAISslopeNEWproteome_Estimates)) +
  ...
  annotate(geom="text", x=xpos_hi(dm$residuals_m2), y=ypos_lo(dm$CAISslopeNEWproteome_Estimates), label=paste("R = ", signif(prrcs$estimate, digits=3), "\n p = ", signif(prrcs$p.value, digits=1)), color="black", size=6) +
...
raics <- cor.test(dm$RaifordAerobicCost,dm$CAISslopeNEWproteome_Estimates, method='spearman') #R=-0.350, p=0.131
raicp <- cor.test(dm$RaifordAerobicCost,dm$CAISslopeNEWproteome_Estimates, method='pearson') #R=-0.288, p=0.218
...
Fig5a <- ggplot(dm, aes(x=mean_LKmarch22, y=CAISslopeNEWproteome_Estimates)) + 
  ...
  annotate(geom="text", x=0.03, y=-0.2, label = paste("R = ", signif(lcs$estimate, digits=3), "\n p = ", signif(lcs$p.value, digits=1)), size=5,  colour = 'black') +
...
Fig5b <- ggplot(dm, aes(x=Disorder_Propensity, y=CAISslopeNEWproteome_Estimates)) + 
  ...
  annotate(geom="text", x=0.92, y=-0.2, label = paste("R = ", signif(dcs$estimate, digits=3), "\n p = ", signif(dcs$p.value, digits=1)), size=5,  colour = 'black') +
  geom_pointrange(aes(ymin=CAISslopeNEWproteome_Estimates-CAISslopeNEWproteome_Std.Error, ymax=CAISslopeNEWproteome_Estimates+CAISslopeNEWproteome_Std.Error)) +
  geom_point(size=3) + 
  geom_text(aes(label=aa),hjust=-0.1, vjust=0, color="blue", size = 6) + 
  mytheme
...
Fig5c <- ggplot(dm, aes(x=VolumeA3, y=CAISslopeNEWproteome_Estimates)) + 
  ...
  annotate(geom="text", x=215, y=-0.2, label = paste("R = ", signif(vcs$estimate, digits=3), "\n p = ", signif(vcs$p.value, digits=1)), size=5,  colour = 'black') +
  geom_pointrange(aes(ymin=CAISslopeNEWproteome_Estimates-CAISslopeNEWproteome_Std.Error, ymax=CAISslopeNEWproteome_Estimates+CAISslopeNEWproteome_Std.Error)) +
  geom_point(size=3) + 
  geom_text(aes(label=aa),hjust=-0.1, vjust=0, color="blue", size = 6) + 
  mytheme
...
Fig5d <- ggplot(dm, aes(x=resid_LKmarch22, y=CAISslopeNEWproteome_Estimates)) + 
  ...
  annotate(geom="text", x=0.045, y=-0.2, label = paste("R = ", signif(rescs$estimate, digits=3), "\n p = ", signif(rescs$p.value, digits=1)), size=5,  colour = 'black') +
  geom_pointrange(aes(ymin=CAISslopeNEWproteome_Estimates-CAISslopeNEWproteome_Std.Error, ymax=CAISslopeNEWproteome_Estimates+CAISslopeNEWproteome_Std.Error)) +
  geom_point(size=3) + 
  geom_text(aes(label=aa),hjust=-0.1, vjust=0, color="blue", size = 6) + 
  mytheme
...
Fig5e <- ggplot(dm, aes(x=RaifordAerobicCost, y=CAISslopeNEWproteome_Estimates)) + 
  ...
  annotate(geom="text", x=70, y=-0.2, label = paste("R = ", signif(raics$estimate, digits=3), "\n p = ", signif(raics$p.value, digits=1)), size=5,  colour = 'black') +
  geom_pointrange(aes(ymin=CAISslopeNEWproteome_Estimates-CAISslopeNEWproteome_Std.Error, ymax=CAISslopeNEWproteome_Estimates+CAISslopeNEWproteome_Std.Error)) +
  geom_point(size=3) + 
...
Fig6a<-ggplot(dm, aes(x=OldNEW_Estimates, y=YoungNEW_Estimates)) +
  ...
  annotate("rect", xmin = 0, xmax = Inf, ymin = 0, ymax = -Inf, fill= "grey90", alpha=0.5) + 
  annotate("rect", xmin = 0, xmax = -Inf, ymin = Inf, ymax = 0, fill= "grey90", alpha=0.5) + 
  annotate(geom="text", x=0.025, y=ypos_lo(dm$YoungNEW_Estimates), label=paste("R = ", signif(oys$estimate, digits=3), "\np = ", signif(oys$p.value, digits=1)), color="black", size=6) +
...
Fig6b<-ggplot(dm, aes(x=NonTransNEW_Estimates, y=TransNEW_Estimates)) +
  ...
  annotate("rect", xmin = 0, xmax = Inf, ymin = 0, ymax = -Inf, fill= "grey90", alpha=0.5) + 
  annotate("rect", xmin = 0, xmax = -Inf, ymin = Inf, ymax = 0, fill= "grey90", alpha=0.5) + 
  annotate(geom="text", x=0.025, y=ypos_lo(dm$TransNEW_Estimates), label=paste("R = ", signif(ntts$estimate, digits=3), "\np = ", signif(ntts$p.value, digits=1)), color="black", size=6) +
...
FigS2<-ggplot(dm, aes(x=CAISslopeNEWPfam_Estimates, y=CAISslopeNEWproteome_Estimates)) +
  ...
  coord_equal() + 
  annotate(geom="text", x=0.12, y=-0.15, label=paste("R = ", signif(pfprs$estimate, digits=3), "\n p = ", signif(pfprs$p.value, digits=1)), color="black", size=6) +
...
FigS3<-ggplot(dm, aes(x=clrCAISslopeNEWproteome_Estimates, y=CAISslopeNEWproteome_Estimates)) +
  ...
  annotate(geom="text", x=xpos_hi(dm$clrCAISslopeNEWproteome_Estimates), y=-0.2, label=paste("R = ", signif(cts$estimate, digits=3), "\n p = ", signif(cts$p.value, digits=1)), color="black", size=6) +
...
myggsave_sq <- function(x){
  ggsave(plot=x, filename=paste0(deparse(substitute(x)), ".svg"), path="C:/Users/hanon/Documents/Github/aa_flux/", device="svg", height=5, width=5, units="in")
}

myggsave_m <- function(x){
  ggsave(plot=x, filename=paste0(deparse(substitute(x)), ".svg"), path="C:/Users/hanon/Documents/Github/aa_flux/", device="svg", height=5, width=7, units="in")
}

#was 3.5x3.5 and 3.5x5

myggsave_gr <- function(x){
  ggsave(plot=x, filename=paste0(deparse(substitute(x)), ".svg"), path="C:/Users/hanon/Documents/Github/aa_flux/", device="svg", height=5, width=8.09, units="in")
}
